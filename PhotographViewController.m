...
@interface PhotographViewController ()<AVCaptureMetadataOutputObjectsDelegate,UIAlertViewDelegate>
...
- (void)customUI{
    ...
    leftButton.frame = CGRectMake(kScreenWidth*1/4.0-50, kScreenHeight-100, 60, 60);
