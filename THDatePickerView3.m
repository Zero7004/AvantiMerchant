...
@interface THDatePickerView3 () <UIPickerViewDelegate, UIPickerViewDataSource>
...
@implementation THDatePickerView3
...
//    self.selectStr = [NSString stringWithFormat:@"%ld-%@-%@", [self.year integerValue], month, day];
    self.selectStr = [NSString stringWithFormat:@"%@:%@", hour, minute];
