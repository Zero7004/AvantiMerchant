...
@interface InProgressCell : UITableViewCell
...
@property (weak, nonatomic) IBOutlet UILabel *deStatus;       //配送状态
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *tableViewHeight;            //tableView高度约束
