...
@interface DrawbackTableViewCell()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation DrawbackTableViewCell
...
//    //计算textview高度
//    _addressConstraintHeight.constant = [Util countTextHeight:_userAddress.text];
//    _refundReasonConsHeight.constant = [Util countTextHeight:_refundRemark.text];

    //设置按钮边框
    [self.disagreeBtn.layer setBorderColor:NAV_COLOR.CGColor];
    [self.disagreeBtn.layer setBorderWidth:1.0];
    [self.disagreeBtn.layer setCornerRadius:5];
//    self.disagreeBtn.layer.masksToBounds = YES;
    [self.agreeBtn.layer setBorderColor:NAV_COLOR.CGColor];
    [self.agreeBtn.layer setBorderWidth:1.0];
    [self.agreeBtn.layer setCornerRadius:5];
//    self.agreeBtn.layer.masksToBounds = YES;

    [self.disagreeBtn setTitleColor:NAV_COLOR forState:UIControlStateNormal];
    [self.agreeBtn setTitleColor:NAV_COLOR forState:UIControlStateNormal];
