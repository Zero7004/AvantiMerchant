...
- (void)initView {
    ...
    self.ratioView.layer.borderColor = NAV_COLOR.CGColor;
...
- (void)initControlBtn {
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 120.0f, 100, 50)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 90.0f, self.view.frame.size.height - 120.0f, 100, 50)];
